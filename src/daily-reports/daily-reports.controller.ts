...
export class DailyReportsController {
  ...
  @Delete(':id')
  @ApiOperation({ summary: 'Xóa daily report (ch? khi PENDING)' })
  ...
  @ApiBody({ schema: { type: 'object', properties: { reject_reason: { type: 'string', example: 'Thi?u mô t?' } }, required: ['reject_reason'] } })
