...
export class AttendanceDashboardDto {
  ...
  @Validate(IsAfter, ['start_date'], { message: 'Ngày kết thúc phải sau ngày bắt đầu' })
  end_date?: string;
...
export class AttendanceReportDto {
  ...
  @ArrayNotEmpty({ message: 'Danh sách ID người dùng không được rỗng khi được cung cấp' })
  @Type(() => Number)
  ...
  @IsIn(['summary', 'detailed', 'penalty', 'leave'], {
    message: 'Loại báo cáo phải là một trong: summary, detailed, penalty, leave'
  })
