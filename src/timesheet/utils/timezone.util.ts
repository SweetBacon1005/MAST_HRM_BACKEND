...
export class TimezoneUtil {
   ...
   */
  static toLocalWorkDate(date?: Date | string, timezoneOffset: number = this.DEFAULT_TIMEZONE_OFFSET): Date {
   ...
   */
  static getTodayWorkDate(timezoneOffset: number = this.DEFAULT_TIMEZONE_OFFSET): Date {
   ...
   */
  static isSameWorkDate(timestamp: Date | string, workDate: Date | string, timezoneOffset: number = this.DEFAULT_TIMEZONE_OFFSET): boolean {
   ...
   */
  static getWorkDateRange(workDate: Date | string, timezoneOffset: number = this.DEFAULT_TIMEZONE_OFFSET): {
    start: Date;
    end: Date;
  } {
    ...
    return {
      start: new Date(localDate.getFullYear(), localDate.getMonth(), localDate.getDate(), 0, 0, 0, 0),
      end: new Date(localDate.getFullYear(), localDate.getMonth(), localDate.getDate(), 23, 59, 59, 999)
    };
  }
   ...
   */
  static formatWorkDate(date: Date | string, timezoneOffset: number = this.DEFAULT_TIMEZONE_OFFSET): string {
